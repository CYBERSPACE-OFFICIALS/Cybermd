...
const initializeBot = async () => {
    ...
    console.log(chalk.green('Cʏʙᴇʀsᴘᴀᴄᴇ x 2025'));
...
function launchBot() {
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅ Cʏʙᴇʀsᴘᴀᴄᴇ x ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴛɪᴠᴇ'));
        } catch (error) {
    ...
    console.log(telegramLoaded ? chalk.green( 'ʀᴏʙɪɴ x 2025 : ᴀᴄᴛɪᴠᴇ ✅') : chalk.red('❌ Cʏʙᴇʀsᴘᴀᴄᴇ x 2025'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ Cʏʙᴇʀsᴘᴀᴄᴇ x 2025 ᴀᴄᴛɪᴠᴇ!\n'));
    }
